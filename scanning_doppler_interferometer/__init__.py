...
def txt2dat(fn: Path) -> pd.DataFrame:
    ...
    dat = pd.read_csv(fn, skiprows=istart+2, nrows=iend-istart-2, sep='\s+',
                      names=['Begin Time', 'End Time', 'Zonal Wind', 'Sigma Zon',
                             'Merid Wind', 'Sigma Mer', 'Vertical Wind', 'Sigma Vz'])
